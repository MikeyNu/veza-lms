...
const rolePermissions: Readonly<Record<BaselineRoleKey, readonly Permission[]>> = Object.freeze({
  "tenant-owner": [
    ...
    permissions.terminologyRead, permissions.terminologyManage, permissions.terminologyApprove,
  ...
  registrar: [
    permissions.membershipRead, permissions.academicPeriodManage,
    permissions.peopleRead, permissions.peopleCreate, permissions.peopleUpdate,
    permissions.peopleSensitiveManage, permissions.peopleIdentityLink, permissions.peopleExport,
    permissions.peopleMerge, permissions.learnerRead, permissions.learnerManage,
    permissions.relationshipRead, permissions.relationshipManage, permissions.peopleImportManage,
    permissions.terminologyRead, permissions.catalogueRead, permissions.curriculumAnalysisRead,
    permissions.courseRunManage, permissions.cohortManage, permissions.classManage,
    permissions.enrolmentRead, permissions.enrolmentManage, permissions.enrolmentTransfer,
    permissions.auditRead,
  ],
  "curriculum-manager": [
    permissions.peopleRead, permissions.terminologyRead, permissions.catalogueRead,
    permissions.outcomeManage, permissions.programmeManage, permissions.programmeApprove,
    permissions.blueprintManage, permissions.blueprintApprove,
    permissions.curriculumSubmitReview, permissions.curriculumAnalysisRead,
  ...
  "course-manager": [
    ...
    permissions.terminologyRead, permissions.catalogueRead, permissions.curriculumAnalysisRead,
    permissions.courseRunManage, permissions.cohortManage,
    permissions.classManage, permissions.enrolmentRead,
  ],
  instructor: [
    permissions.courseDeliver, permissions.peopleRead, permissions.learnerRead,
    permissions.terminologyRead, permissions.catalogueRead, permissions.enrolmentRead,
  ...
  auditor: [
    permissions.evidenceRoomRead, permissions.auditRead, permissions.terminologyRead,
    permissions.catalogueRead, permissions.curriculumAnalysisRead, permissions.enrolmentRead,
  ],
