...
function humanize(value: string): string {
  return value.replaceAll(/[._-]+/g, " ").replace(/\w\b/g, (letter) => letter.toUpperCase());
}

function nextHref(filters: PlatformAuditFilters, cursor: string) {
  ...
  return { pathname: "/audit", query: Object.fromEntries(params.entries()) };
}
    ...
    <div className="platform-audit-layout">
      <aside className="platform-audit-filters">
        ...
        <form method="get" action="/audit">
          ...
          <label>Actor ID<innput name="actorId" defaultValue={filters.actorId} placeholder="Operator UUID"/></label>
