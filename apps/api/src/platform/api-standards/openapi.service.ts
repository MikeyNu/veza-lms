...
const operations: readonly OperationDefinition[] = [
  ...
  { method: "get", path: "/v1/service-accounts", operationId: "listServiceAccounts", summary: "List tenant service accounts", tag: "Service accounts", boundary: "tenant", security: bearer },
