...
const engagementTypes = ["employee", "contractor", "volunteer", "external"] as const;
...
export class UpsertLearnerProfileDto {
  ...
  @IsIn(learnerStatuses)
  status!: (typeof learnerStatuses)[number];
...
export class DuplicateDecisionDto {
  @IsIn(["confirmed-duplicate", "not-duplicate"])
