...
import { PersonIdentityAcceptanceService } from "./application/person-identity-acceptance.service.js";
import { AccessDirectoryController } from "./http/access-directory.controller.js";
import { AccessInvitationLifecycleController } from "./http/access-invitation-lifecycle.controller.js";
...
@Module({
  controllers: [
    ...
    AccessInvitationLifecycleController,
  ],
  providers: [
    ...
    AccessInvitationLifecycleService,
    PersonIdentityAcceptanceService,
