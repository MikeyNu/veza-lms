...
export async function POST(
  ...
  try {
    ...
    const { institutionId: _institutionId, ...relationship } = body;
    return NextResponse.json(
      await createRelationship(personId, institutionId, relationship),
