...
const definitions: readonly NavigationDefinition[] = [
  ...
  { key: "assess", labels: { default: "Assess", learner: "Assessments", moderator: "Moderation" }, href: "/assessments", icon: "check", roles: ["tenant-owner", "institution-admin", "registrar", "course-manager", "instructor", "assessor", "moderator", "learner"] },
