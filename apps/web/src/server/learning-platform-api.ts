...
export function mutateStudio(
  ...
  > = {
    ...
    "revision-save": {
      method: "PUT",
      path: (body) => `lessons/${inputUuid(body, "lessonId", "Lesson")}/revisions`,
    },
    "reusable-block-create": { method: "POST", path: () => "reusable-blocks" },
    "asset-register": { method: "POST", path: () => "assets" },
    "asset-scan": {
      method: "POST",
      path: (body) => `assets/${inputUuid(body, "assetId", "Asset")}/scan`,
    },
    "comment-create": {
      method: "POST",
      path: (body) => `lessons/${inputUuid(body, "lessonId", "Lesson")}/comments`,
    },
    "comment-status": {
      method: "PUT",
      path: (body) => `comments/${inputUuid(body, "commentId", "Comment")}/status`,
    },
    "review-request": {
      method: "POST",
      path: (body) => `lessons/${inputUuid(body, "lessonId", "Lesson")}/reviews`,
    },
    "review-decision": {
      method: "POST",
      path: (body) => `reviews/${inputUuid(body, "reviewId", "Review")}/decision`,
    },
    "course-publish": {
      method: "POST",
      path: (body) =>
        `course-spaces/${inputUuid(body, "courseSpaceId", "Course space")}/publish`,
    },
  ...
  return request(`/v1/institutions/${institutionId}/studio/${path}`, {
...
export function mutateAcademic(
  ...
  > = {
    "assignment-create": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/assignments`,
    },
    "assignment-publish": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/assignments/${inputUuid(body, "assignmentId", "Assignment")}/publish`,
    },
    accommodation: {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/assignments/${inputUuid(body, "assignmentId", "Assignment")}/accommodations`,
    },
    "rubric-create": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/rubrics`,
    },
    "rubric-submit": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/rubrics/${inputUuid(body, "rubricId", "Rubric")}/submit`,
    },
    "rubric-approve": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/rubrics/${inputUuid(body, "rubricId", "Rubric")}/approve`,
    },
    "rubric-attach": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/assignments/${inputUuid(body, "assignmentId", "Assignment")}/rubric`,
    },
    "assignment-group-create": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/assignments/${inputUuid(body, "assignmentId", "Assignment")}/groups`,
    },
    "assignment-group-members": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/assignment-groups/${inputUuid(body, "groupId", "Assignment group")}/members`,
    },
    "submission-start": { method: "POST", path: () => "submissions" },
    "submission-file": {
      method: "POST",
      path: (body) =>
        `submissions/${inputUuid(body, "attemptId", "Submission attempt")}/files`,
    },
    "submission-offset": {
      method: "POST",
      path: (body) =>
        `submission-files/${inputUuid(body, "fileId", "Submission file")}/offset`,
    },
    "submission-finalize": {
      method: "POST",
      path: (body) =>
        `submissions/${inputUuid(body, "attemptId", "Submission attempt")}/finalize`,
    },
    "marker-allocate": {
      method: "POST",
      path: (body) =>
        `submissions/${inputUuid(body, "attemptId", "Submission attempt")}/markers`,
    },
    "mark-record": {
      method: "POST",
      path: (body) =>
        `submissions/${inputUuid(body, "attemptId", "Submission attempt")}/marks`,
    },
    "mark-release": {
      method: "POST",
      path: (body) => `marks/${inputUuid(body, "markId", "Mark")}/release`,
    },
    "grade-category": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/gradebook/categories`,
    },
    "grade-item": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/gradebook/items`,
    },
    "formula-create": { method: "POST", path: () => "gradebook/formulas" },
    "formula-activate": {
      method: "POST",
      path: (body) =>
        `gradebook/formulas/${inputUuid(body, "formulaId", "Formula")}/activate`,
    },
    ...
    "certificate-template": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/certificate-templates`,
    },
    "certificate-template-submit": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/certificate-templates/${inputUuid(body, "templateId", "Certificate template")}/submit`,
    },
    "certificate-template-approve": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/certificate-templates/${inputUuid(body, "templateId", "Certificate template")}/approve`,
    },
    "award-rule": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/award-rules`,
    },
    "award-evaluate": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/award-rules/${inputUuid(body, "awardRuleId", "Award rule")}/evaluate`,
    },
    "certificate-issue": {
      method: "POST",
      path: (body) =>
        `institutions/${inputUuid(body, "institutionId", "Institution")}/certificates`,
    },
    "certificate-revoke": {
      method: "POST",
      path: (body) =>
        `certificates/${inputUuid(body, "certificateId", "Certificate")}/revoke`,
    },
    export: {
      method: "POST",
      path: (body) => {
  ...
  return request(`/v1/academic-evidence/${path}`, {
    method: target.method,
    body: JSON.stringify(payload),
  });
}
