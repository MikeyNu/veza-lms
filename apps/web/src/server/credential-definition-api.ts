import { requireRecord, type JsonRecord } from "./json-contract";
...
async function request(path: string, input: Readonly<Record<string, unknown>>): Promise<JsonRecord> {
  return requireRecord(
    await requestWorkspaceJson(path, {
